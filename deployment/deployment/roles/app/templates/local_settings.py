...
HOST = "http://{{samestrem.hostname}}"

# Database Settings
DATABASES = {
    {% for k, d in samestrem.db.items() %}
    '{{k}}': {
...
CACHES = {
    'default': {
        ...
        'LOCATION': '{{memcache.host}}:{{memcache.port}}',
    }
}
...
SESSION_COOKIE_DOMAIN = '{{samestrem.hostname}}'

SESSION_COOKIE_SECURE = True

MEDIA_ROOT = '{{samestrem.install_dir}}/media/'
MEDIA_URL = '/media/'

STATIC_ROOT = '{{samestrem.install_dir}}/static_collected/'
STATIC_URL = '/static_collected/'
STATICFILES_DIRS = ['{{samestrem.install_dir}}/web/static']
